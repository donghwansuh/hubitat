/*
 * Galaxy Home Mini IR Remote Wall Switch (Using Smartthings REST API)
 *
 ...
 */
metadata {
    definition(name: "Galaxy Home Mini IR Remote Wall Switch", namespace: "donghwansuh", author: "Donghwan Suh") {
        capability "Actuator"
