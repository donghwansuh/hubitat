/*
 * Galaxy Home Mini IR Remote Fan Hubitat driver (Using Smartthings REST API)
 *
 ...
 */
metadata {
    definition(name: "Galaxy Home Mini IR Remote Fan", namespace: "donghwansuh", author: "Donghwan Suh") {
        capability "Actuator"
...
def fanButton(){
    def params = buildParms("statelessCustomButton", "setButton", "fanspeed")
    post(params)
}

def rotationButton(){
    def params = buildParms("statelessCustomButton", "setButton", "rotate")
    post(params)
}

def timerButton(){
    def params = buildParms("statelessCustomButton", "setButton", "timer")
    post(params)
}
