/*
 * Galaxy Home Mini IR Remote Air Purifier Hubitat driver (Using Smartthings REST API)
 *
 ...
 */
metadata {
    definition(name: "Galaxy Home Mini IR Remote Air Purifier", namespace: "donghwansuh", author: "Donghwan Suh") {
        capability "Actuator"
...
def fanButton(){
    def params = buildParms("statelessFanspeedModeButton", "setButton", "changeMode")
    post(params)
}

def modeButton(){
    def params = buildParms("statelessAirCleanerModeButton", "setButton", "changeMode")
    post(params)
}
